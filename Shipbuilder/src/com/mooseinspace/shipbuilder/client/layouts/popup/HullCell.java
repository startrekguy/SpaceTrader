...
public class HullCell extends AbstractCell<ShipHull> {
	...
	@Override
	public void render(com.google.gwt.cell.client.Cell.Context context, ShipHull value, SafeHtmlBuilder sb) 
	{
		if (value == null)
		{
			return;
		...
		SafeHtml safeName = SafeHtmlUtils.fromString(value.getShipHullName());
